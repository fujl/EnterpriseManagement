...
@protocol EMRequesterDelegate <NSObject>
...
@interface EMHttpRequester : NSObject

// 请求数据，参数
@property(nonatomic, weak) id <EMRequesterDelegate> delegate;
 ...
 */
- (void)doRequest:(void (^)(AMResultCode code, id data))resultListener withDelay:(NSTimeInterval)delayTime;
